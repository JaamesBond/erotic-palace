...
from file_upload import insert_photo, update_girl_photo_url, delete_girl_photos

app = Flask(__name__.split('.')[0], template_folder='/home/matei/PycharmProjects/Admin_API/Templates')
...
def newgirl():
    if request.method == "GET":
        ...
        girl_id = add_girl(girl["name"], girl["age"], girl["hair_colour"], girl["phone"], girl["boobs"], girl["ass"],
                           girl["race"], girl["bmi"], girl["personality"], girl["services"])
